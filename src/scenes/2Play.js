class tPlay extends Phaser.Scene {
    constructor() {
        super("2playScene");
    }
...
create() {
    ...
    //this.p2Rocket = new Rocket(this, game.config.width*2/3, game.config.height - borderUISize - borderPadding, 'rocket').setOrigin(0.5, 0);
